                ...
                <div className="hidden-mobile" style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
                    {navLinks.map((link) => (
                        <a
                            key={link.name}
                            href={link.href}
                            style={{ fontSize: '0.9rem', fontWeight: 500, color: 'var(--text-muted)', transition: 'color 0.2s' }}
                    ...
                    >
                        {navLinks.map((link) => (
                            <a
                                ...
                                style={{ padding: '0.75rem', fontSize: '1.1rem', fontWeight: 500, borderBottom: '1px solid var(--border-color)' }}
                            >
                                {link.name}
                            </a>
                        ))}
